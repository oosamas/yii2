...
//                            'badge' => TimelineEvent::find()->today()->count(),
//                            'badgeBgClass' => 'badge-success',
                             'visible' => Yii::$app->user->can('dashboard-reports'),
                        ],
                        ...
                        [
                            ...
                            'options' => ['class' => 'nav-header'],
                            'visible' => Yii::$app->user->can('manage-fee-n-payments'),
                        ],
                        
                        [
                            'label' => Yii::t('backend', 'Accounts & Collections'),
                            'url' => '#',
                            'icon' => FAS::icon('pound-sign', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => 'studentms' === Yii::$app->controller->module->id &&
                                ('student-fee' === Yii::$app->controller->id || 'student-fee-payment' === Yii::$app->controller->id),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Fee'),
                                    'url' => ['/studentms/student-fee'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'student-fee',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Payment Receipts'),
                                    'url' => ['/studentms/student-fee-payment'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'student-fee-payment',
                                ],
                            ],
                            'visible' => Yii::$app->user->can('manage-fee-n-payments'),
                        ],
...
//                            'visible' => Yii::$app->user->can('administrator'),
                        ...
                        [
                            'label' => Yii::t('backend', 'Admissions'),
                            'url' => '#',
                            'icon' => FAS::icon('mail-bulk', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => 'studentms' === Yii::$app->controller->module->id &&
                                (
//                                    'student' === Yii::$app->controller->id || 'student-information' === Yii::$app->controller->id ||
                                     'intake' === Yii::$app->controller->id   
                                    || 'application-detail' === Yii::$app->controller->id   
                                    ),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Intake'),
                                    'url' => ['/studentms/intake'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'intake',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Applications'),
                                    'url' => ['/studentms/application-detail'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'application-detail',
                                ],
                            ],
                            'visible' => Yii::$app->user->can('admission-application'),
                        ],
                        [
                            'label' => Yii::t('backend', 'Enrollments'),
                            'url' => '#',
                            'icon' => FAS::icon('user-graduate', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => 'studentms' === Yii::$app->controller->module->id &&
                                ('student' === Yii::$app->controller->id || 'enrollment' === Yii::$app->controller->id
                                 
                                    ),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Enrollment'),
                                    'url' => ['/studentms/enrollment/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'enrollment',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Student List'),
                                    'url' => ['/studentms/student/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'student',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Student Modules'),
                                    'url' => ['/studentms/student-modules/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'student-modules',
                                ],
                                
                            ],
                            'visible' => Yii::$app->user->can('manage-student'),
                        ],
                        [
                            'label' => Yii::t('backend', 'Operations'),
                            'url' => '#',
                            'icon' => FAS::icon('sliders-h', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => 'studentms' === Yii::$app->controller->module->id &&
                                (
                                    'course-type' === Yii::$app->controller->id || 
                                    'course-' === Yii::$app->controller->id || 
                                    'module-detail' === Yii::$app->controller->id ||
                                    Yii::$app->controller->id === 'student-level'
                                ),
                                    
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Course Type'),
                                    'url' => ['/studentms/course-type/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'course-type',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Course'),
                                    'url' => ['/studentms/course/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'course',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Module'),
                                    'url' => ['/studentms/module-detail/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'module-detail',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Level'),
                                    'url' => ['/studentms/student-level/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'student-level',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Course Modules'),
                                    'url' => ['/studentms/course-modules/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'module-modules',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Module Teachers'),
                                    'url' => ['/studentms/module-teacher/index'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'module-teacher',
                                ],
                                [
                            ...
                            'visible' => Yii::$app->user->can('general-operations'),
                        ],
                        
                        [
                            'label' => Yii::t('backend', 'Attendance'),
                            'url' => ['/studentms/student-attendance/create-multiple'],
                            'icon' => FAS::icon('clipboard-list', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'student-attendance',
                            'visible' => Yii::$app->user->can('mark-student-attendance'),
                        ],
                        
                        [
                            'label' => Yii::t('backend', 'Examination'),
                            'options' => ['class' => 'nav-header'],
                            'visible' => Yii::$app->user->can('manage-fee-n-payments'),
                        ],
                        
                        [
                            'label' => Yii::t('backend', 'Assessment Management'),
                            'url' => '#',
                            'icon' => FAS::icon('list', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => 'assessmentms' === Yii::$app->controller->module->id &&
                                ('assessment' === Yii::$app->controller->id || 'assessment-result' === Yii::$app->controller->id),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Assessment'),
                                    'url' => ['/assessmentms/assessment'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'assessment',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Assessment Results'),
                                    'url' => ['/assessmentms/assessment-result'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'assessment-result',
                                ],
                            ],
                            'visible' => Yii::$app->user->can('manage-assessment') or Yii::$app->user->can('list-assessment'),
                        ],
                        [
                            'label' => Yii::t('backend', 'Access'),
                            'options' => ['class' => 'nav-header'],
                            'visible' => Yii::$app->user->can('general-operations'),
                        ],
                        [
                            ...
                            'items' => [
                                [
                                    ...
                                    'url' => ['/user-management/user/index?UserSearch[gridRoleSearch]=teacher'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'user',
                                ],
                                [
                                    'label' => Yii::t('backend', 'Students'),
                                    'url' => ['/user-management/user/index?UserSearch[gridRoleSearch]=user'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
                                    'active' => Yii::$app->controller->id === 'user',
                                ],
                                [
                        ...
                        [
                            ...
                            'url' => '#',
                            'icon' => FAS::icon('sms', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => 'notification' === Yii::$app->controller->module->id &&
                                ('notification' === Yii::$app->controller->id || 'notification' === Yii::$app->controller->id),
                            'items' => [
                                [
                                ...
                                [
                                    ...
                                    'url' => ['/studentms/admission-application/create'],
                                    'icon' => FAR::icon('circle', ['class' => ['nav-icon']]),
