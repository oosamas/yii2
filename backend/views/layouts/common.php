                    ...
                    'items' => [
                      ...
                      [
                        ...
                        'items' => [
                            ...
                            //     'url' => ['/content/category/index'],
                            //     'icon' => FAR::icon('chart-simple', ['class' => ['nav-icon']]),
                            //     'active' => Yii::$app->controller->id === 'category',
                            // ],
                            [
                            ...
                            // 'url' => ['/content/category/index'],
                            // 'icon' => FAR::icon('water-ladder', ['class' => ['nav-icon']]),
                            // 'active' => Yii::$app->controller->id === 'category',
                            // ],
                            [
                              ...
                              'active' => Yii::$app->controller->id === 'points',
                          ],
                              ],
                        // 'visible' => Yii::$app->user->can('administrator'),
                    ],
                  ...
                  [
                    ...
                    'items' => [
                        [
                            ...
                            'url' => ['/content/article/index'],
                            'icon' => FAR::icon('phone', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'article',
                        ],
                        [
                            'label' => Yii::t('backend', 'Course Management'),
                            'url' => ['/content/category/index'],
                            'icon' => FAR::icon('laptop-file', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'category',
                        ],
                        [
                            'label' => Yii::t('backend', 'Set Lesson for Student'),
                            'url' => ['/content/category/index'],
                            'icon' => FAR::icon('ellipsis', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'category',
                        ],
                        [
                        ...
                        [
                            ...
                            'url' => ['/content/category/index'],
                            'icon' => FAR::icon('star', ['class' => ['nav-icon']]),
                            'active' => Yii::$app->controller->id === 'category',
                        ],
                    ],
                    // 'visible' => Yii::$app->user->can('administrator'),
