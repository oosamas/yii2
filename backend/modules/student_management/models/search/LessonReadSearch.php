...
use backend\modules\student_management\models\LessonRead;

/**
 * LessonReadSearch represents the model behind the search form about `backend\modules\student_management\models\LessonRead`.
 */
