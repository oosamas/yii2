    ...
    <?php $form = ActiveForm::begin(); ?>
        <div class="card">
            <div class="card-body">
                ...
                <?php echo $form->field($model, 'live_support')->textInput() ?>
                <?php echo $form->field($model, 'fee_type')->textInput(['maxlength' => true]) ?>
                <?php echo $form->field($model, 'duration')->textInput(['maxlength' => true]) ?>
